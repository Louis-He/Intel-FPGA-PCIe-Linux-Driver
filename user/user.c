...
// Each loop contains 2 runs to test wrap around of last descriptor pointer
        printf("Read Time               : %lld s and %ld ns\n", ((struct dma_status *)buf)->read_time.tv_sec, ((struct dma_status *)buf)->read_time.tv_nsec);
        printf("Read Throughput         : %lf GB/S\n", (((struct dma_status *)buf)->length_transfer*0.954)/((((struct dma_status *)buf)->read_time.tv_nsec + 1000000000*((struct dma_status *)buf)->read_time.tv_sec ) / 1000.0));
        printf("Write Time              : %lld s and %ld ns\n", ((struct dma_status *)buf)->write_time.tv_sec, ((struct dma_status *)buf)->write_time.tv_nsec);
        printf("Write Throughput        : %lf GB/S\n", (((struct dma_status *)buf)->length_transfer*0.954)/((((struct dma_status *)buf)->write_time.tv_nsec + 1000000000*((struct dma_status *)buf)->write_time.tv_sec ) / 1000.0));
        printf("Simultaneous Time       : %lld s and %ld ns\n", ((struct dma_status *)buf)->simul_time.tv_sec, ((struct dma_status *)buf)->simul_time.tv_nsec);
        printf("Simultaneous Throughput : %lf GB/S\n", (((struct dma_status *)buf)->length_transfer*0.954*2)/((((struct dma_status *)buf)->simul_time.tv_nsec + 1000000000*((struct dma_status *)buf)->simul_time.tv_sec ) / 1000.0));
